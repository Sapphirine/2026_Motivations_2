...
app.get('/api/findings/heatmap', async (c) => {
  ...
  return c.json({
    ...
    cells: job.results.map((cell) => ({
      ...
      contrastMode: cell.contrastMode ?? 'baseline_perturbed',
      lowOption: cell.lowOption ?? null,
      highOption: cell.highOption ?? null,
      lowRationaleExcerpt: cell.lowRationaleExcerpt ?? '',
      highRationaleExcerpt: cell.highRationaleExcerpt ?? '',
      baselineOption: cell.baselineOption,
      perturbedOption: cell.perturbedOption,
      perturbedRationaleExcerpt: cell.perturbedRationaleExcerpt,
